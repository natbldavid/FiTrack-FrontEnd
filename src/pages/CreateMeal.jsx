...
function CreateMeal() {
  ...
  const returnedFromFoodItemPicker =
  location.state?.returnedFromFoodItemPicker === true
  ...
  const handleAddFood = () => {
  navigate(ROUTES.FOOD_ADD_TO_MEAL, {
    state: {
      draftMeal: {
        name: mealName,
        items: mealItems,
      ...
      <div className="mx-auto w-full max-w-3xl px-4 pb-8 pt-4">
        ...
        <section className="mt-4 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200/70">
          <div className="flex items-center justify-between">
            <h2 className="text-base font-semibold text-black">Meal Photo</h2>
